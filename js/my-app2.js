...
/*
 ...
 $.ajax({
    ...
    success: function (data, textStatus, jqXHR) { 
       // Template7.data = { noticia: data };
        myApp.template7Data = collect(myApp.template7Data, { noticias: data });
    ...
    preprocess: function (content, url, next) {
       $$.get('http://interlab.com.ec/wp-json/posts', function(data) {
                // Template
         ...
         $.ajax({
            ...
            success: function (data, textStatus, jqXHR) { 
               // Template7.data = { noticia: data };
                ...
                //    newObject[data[i].ID] = data[i];
                //};
                //myApp.template7Data = collect(myApp.template7Data, { noticias: newObject });
...
/*
$$.getJSON('http://interlab.com.ec/wp-json/posts', function (data) {
                  console.log(data);
                    myApp.params.template7Data['noticias'] = data;
                    console.log(myApp.template7Data);
      ...
      success: function(response){  
        ...
        if(response!=null && response!='' && response!='[]'){ 
          ...
          $.each(response,function(key,value){ 
            ...
            //console.log('alfabeto'+alfabeto[pL]);
